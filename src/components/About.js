      ...
      <div className="about__container bd-grid">
        ...
        <div>
          ...
          <p className="about__text">
            ...
            machine learning, and data science. To pursue my interests, I have
            taken two elective focuses during college, one in Data Science and
            Analytics and the other in High Performance Computing. In my free
