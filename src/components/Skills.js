        ...
        <section className="skills section" id="skills">
            ...
            <div className="skills__container bd-grid">
                ...
                <p className="skills__text">
                    The technology stack that I'm currently working on includes, but not limited to, Python, Java, React.js, and Node.js.
                </p>
                ...
                <div className="skills__list">
                    ...
                    <div className="skills__data">
                        <div className="skills__names">
                            <i className='bx bx-code skills__icon' ></i>
                            <span className="skills__name">Machine Learning/Deep Learning</span>
                        </div>
                    </div>
                    <div className="skills__data">
                        <div className="skills__names">
